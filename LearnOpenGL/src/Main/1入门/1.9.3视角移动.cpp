...
int main()
{
    ...
    glfwSetFramebufferSizeCallback(window, framebuffer_size_callback);// 窗口大小改变事件
    glfwSetCursorPosCallback(window, mouse_callback);// 鼠标位置事件
    glfwSetScrollCallback(window, scroll_callback); // 鼠标滚动事件
