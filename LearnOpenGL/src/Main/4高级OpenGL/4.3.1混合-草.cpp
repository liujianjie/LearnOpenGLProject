...
int main()
{
    ...
    // -------------------------
    Shader shader("assest/shader/4高级OpenGL/3.1.混合-草.vs", "assest/shader/4高级OpenGL/3.1.混合-草.fs");
    ...
    unsigned int grassTexture = loadTexture(FileSystem::getPath("assest/textures/grass.png").c_str());
