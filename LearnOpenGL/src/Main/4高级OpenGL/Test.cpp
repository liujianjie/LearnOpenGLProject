...
int main()
{
   ...
   // -------------------------
    ...
    Shader shader("assest/shader/4高级OpenGL/1.1.depth_testing.vs", "assest/shader/4高级OpenGL/1.1.depth_testing.fs");
    ...
    unsigned int transparentTexture = loadTexture(FileSystem::getPath("assest/textures/grass.png").c_str());
