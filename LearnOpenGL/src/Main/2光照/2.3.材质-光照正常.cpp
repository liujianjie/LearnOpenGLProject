...
int main()
{
    ...
    // 物体的光照shader
    Shader lightingShader("assest/shader/2光照/2.3.2.材质-光照正常.vs", "assest/shader/2光照/2.3.2.材质-光照正常.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //lightingShader.setVec3("lightPos", lightPos);// 若放外面，得记得lightingShader.use();，而我就忘记了
        
        lightingShader.setVec3("viewPos", camera.Position);

        // 随着时间改变物体颜色，其实是物体反射颜色
        glm::vec3 lightColor;
