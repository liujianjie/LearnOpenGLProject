...
int main()
{
    ...
    // 物体的光照shader
    Shader lightingShader("assest/shader/2光照/2.5.3.1投光物-聚光灯-不平滑的过渡.vs", "assest/shader/2光照/2.5.3.1投光物-聚光灯-不平滑的过渡.fs");
    // 光源shader
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //float theta1 = glm::dot(lightDir, glm::normalize(-lightdirection));
        //cout << "像素点指向光源：" << theta1 << endl;
        //float theta2 = glm::dot(-lightDir, glm::normalize(lightdirection));
